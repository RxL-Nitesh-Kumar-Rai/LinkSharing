            ...
            <div class="card item item2">
                ...
                <g:each in="${user.subscriptions}">
                    <div class="card body-item2">
                        ...
                        <div class="i2-item11">
                            <g:img dir="images" style="margin-left: 60" file="invite.png" height="30px" width="30px" id="subscriptionInvite" title="Click to invite"/>
                            <g:if test="${(it.topic.createdBy.userName==session.sessionId)|| session.isAdmin}">
                            ...
                            <div class="i4-item8">
                                ...
                                <g:if test="${session.sessionId!=it.createdBy.userName}">
                                    <g:if test="${flag=="true"}">
                                        ...
                                        <a href="" class="trendingTopicLink1">Unsubscribe</a>
                                    </g:if>
                                    <g:else>
                                        <a href="" class="trendingTopicLink2">Subscribe</a>
                                    </g:else>
                                </g:if>
                            </div>
